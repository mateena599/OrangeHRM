package com.UserRegistrationExcel;
...
import com.NewtourExcel.Baseclass;

public class UserRegistrationNewtours 
{
	...
	{
	FileInputStream file = new FileInputStream("./src/com/ApplicationTesTDataFiles/Excel_MultipleUserRegistration_TestData.xlsx");
	...
	double p=row.getCell(8).getNumericCellValue();
	long y=(long)p;
	...
	userName.clear();
	userName.sendKeys(row.getCell(10).getStringCellValue());
	...
	String expected_UserName=row.getCell(10).getStringCellValue();
	...
	row.createCell(13).setCellValue("User Registered Successfully - PASS");
	}
	else
	{
	System.out.println(" User Registration Failed - FAIL");
	row.createCell(13).setCellValue("User Registration Failed - FAIL");
	}

	FileOutputStream file1 = new FileOutputStream("./src/com/ApplicationTestResultFiles/NewTours_NewUserRegistration_TestResult.xlsx");
